      ...
      child: Column(
        ...
        children: [
          const Padding(
            ...
            child: Text('Moduly', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold))
          ),
          Padding(
    ...
    return InkWell(
      onTap: isLocked || page == null
          ? () => ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Tento modul připravujeme v další verzi!'))
            )
          : () => Navigator.push(
                context, 
                MaterialPageRoute(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isLocked ? Colors.grey.withOpacity(0.2) : color.withOpacity(0.3), 
            width: 2
          ),
          boxShadow: [
            if (!isDark) 
