...
class _PultovyProdejTabState extends State<_PultovyProdejTab> {
  ...
  void _pridatDoKosiku() {
    ...
    if (mnozstvi > aktualniStav) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Chyba: Požadované množství ($mnozstvi) převyšuje stav skladu ($aktualniStav).'), backgroundColor: Colors.red)
      );
      return;
    }
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              subtitle: Text('${p['mnozstvi']} ${p['jednotka']} x ${p['cena_prodej']} Kč'),
                              trailing: IconButton(
  ...
  Future<void> _dokoncitProdej() async {
    ...
    try {
      ...
      String cisloFaktury = 'PRODEJ-$timestamp'; 
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Prodej byl úspěšně dokončen, účtenka (PDF) byla vytvořena v záložce Faktury.'), backgroundColor: Colors.green));
      }
    } catch (e) {
                            ...
                            Expanded(
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  label: const Text('PŘIDAT DO KOŠÍKU', style: TextStyle(fontWeight: FontWeight.bold)),
