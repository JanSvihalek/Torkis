...
class _NovaRezervaceScreenState extends State<NovaRezervaceScreen> {
  ...
  // --- LOGIKA PRO VYHLEDÁVÁNÍ A SKENOVÁNÍ VOZIDLA ---
  ...
  // --- ULOŽENÍ REZERVACE POUZE DO PLÁNOVAČE ---
...
class _VyberZakaznikaSheetState extends State<_VyberZakaznikaSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    if (globalServisId == null) return const Center(child: CircularProgressIndicator());
