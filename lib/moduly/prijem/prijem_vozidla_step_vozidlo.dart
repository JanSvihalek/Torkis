          ...
          child: Column(
            ...
            children: [
              ...
              buildDropdown(
                'Typ záznamu',
                Icons.label_outline,
                typyZaznamu.contains(typZaznamu)
                    ? typZaznamu
                    : typyZaznamu.first,
                typyZaznamu,
                (v) {
                  if (v != null) onTypZaznamuChanged(v);
                },
                isDark,
              ),
              const SizedBox(height: TokSpace.lg),
              ...
              Column(
                ...
                children: [
                  ...
                  OutlinedButton.icon(
                    onPressed: isLoadingSpz ? null : onHledatSpz,
                    icon: isLoadingSpz
                        ? const SizedBox(
                            width: 14,
                            height: 14,
              ...
              Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      OutlinedButton.icon(
                        onPressed: isLoadingVin ? null : onHledatVin,
                        icon: isLoadingVin
                            ? const SizedBox(
                                width: 14,
                                height: 14,
                      ...
                      if (onDekovatVin != null)
                        OutlinedButton.icon(
                          onPressed: isLoadingVincario ? null : onDekovatVin,
                          icon: isLoadingVincario
                              ? const SizedBox(
                                  width: 14,
                                  height: 14,
                                  child: CircularProgressIndicator(
