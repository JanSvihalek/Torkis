      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              Text(l10n.prijemStavTitle,
                  style: const TextStyle(
                      fontSize: 32, fontWeight: FontWeight.bold)),
              const SizedBox(height: 30),
              buildInput(l10n.prijemStavTacho, Icons.speed, tachometrController,
                  isDark,
                  numbersOnly: true),
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(l10n.prijemStavNadrz(stavNadrze.toInt()),
                      style: const TextStyle(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.local_gas_station,
                            color: stavNadrze < 20 ? Colors.red : Colors.blue),
                        Expanded(
                            child: Slider(
                                value: stavNadrze,
                                min: 0,
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: l10n.prijemStavVlastniPopis,
                                  isDense: true,
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(l10n.prijemStavPlatnostStk,
                      style: const TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.grey)),
                  const SizedBox(height: 8),
                  Row(children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      maxLines: 4,
                      decoration: InputDecoration(
                          hintText: l10n.prijemStavPoznamkyHint,
