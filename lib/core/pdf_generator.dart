...
class GlobalPdfGenerator {
  ...
  static Future<Uint8List> generateDocument({
    ...
    // ZJISTÍME SPLATNOST (buď byla předána v 'data', nebo default 14)
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  ...
                  if (typ == PdfTyp.faktura) ...[
                    pw.SizedBox(height: 2),
                    pw.Text(
                      'Splatnost: ${DateFormat('dd.MM.yyyy').format(datumSplatnosti)}',
                      style: pw.TextStyle(
                        font: fontBold,
                        fontSize: 10,
                ...
                child: pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      if (zakaznik['dic'] != null &&
                          zakaznik['dic'].toString().isNotEmpty)
                        pw.Text(
                          'DIČ: ${zakaznik['dic']}',
                          style: pw.TextStyle(
                            font: fontMedium,
                      ...
                      pw.SizedBox(height: 6),
                      if (zakaznik['telefon'] != null &&
                          zakaznik['telefon'].toString().isNotEmpty)
                        pw.Text(
                      ...
                      if (zakaznik['email'] != null &&
                          zakaznik['email'].toString().isNotEmpty)
                        pw.Text(
                ...
                ...provedenePrace.expand((prace) {
                  ...
                  return [
                    ...
                    ...items.map((item) {
                      ...
                      if (item['cislo'] != null &&
                          item['cislo'].toString().trim().isNotEmpty) {
